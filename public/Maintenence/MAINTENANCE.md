...
firebase deploy --only hosting:maintenance --project nightdev4l) Fallback: keep the client-side overlay (already enabled in this repo). No server status change; simplest, but not as strong as a true 503.
